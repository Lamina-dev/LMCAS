...
LAMINA_API SymbolicSetResult make_finite_set(
...
LAMINA_API SymbolicSetResult make_interval(
...
LAMINA_API SymbolicSetResult make_membership(
    const std::shared_ptr<SymbolicExpr>& element,
    const std::shared_ptr<SymbolicExpr>& set,
    ComputationContext& context);

LAMINA_API SymbolicSetResult finite_set_union(
    const SymbolicExpr& lhs, const SymbolicExpr& rhs,
    ComputationContext& context);
LAMINA_API SymbolicSetResult finite_set_intersection(
    const SymbolicExpr& lhs, const SymbolicExpr& rhs,
    ComputationContext& context);
LAMINA_API SymbolicSetResult finite_set_difference(
    const SymbolicExpr& lhs, const SymbolicExpr& rhs,
    ComputationContext& context);
LAMINA_API SymbolicSetResult finite_set_symmetric_difference(
    const SymbolicExpr& lhs, const SymbolicExpr& rhs,
    ComputationContext& context);
