 ...
 * @return 逆变度量张量 g^ij
 */
LMCAS_API DifferentialGeometryExprResult metric_inverse_checked(
 ...
 * @return 符号表达式
 */
LMCAS_API DifferentialGeometryExprResult christoffel_first_kind_checked(
    const std::shared_ptr<SymbolicExpr>& g_ij,
 ...
 * @return 符号表达式
 */
LMCAS_API DifferentialGeometryExprResult christoffel_second_kind_checked(
    const std::shared_ptr<SymbolicExpr>& g_ij,
 ...
 * @return 符号表达式
 */
LMCAS_API DifferentialGeometryExprResult riemann_curvature_tensor_checked(
    const std::shared_ptr<SymbolicExpr>& g_ij,
    const std::vector<std::string>& coords,
 ...
 * @return 李导数表达式
 */
LMCAS_API DifferentialGeometryExprResult lie_derivative_checked(
 ...
 * @return 外微分后的系数列表
 */
LMCAS_API DifferentialGeometryVectorResult exterior_derivative_checked(
