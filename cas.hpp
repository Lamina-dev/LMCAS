...
LAMINA_API Value cas_det(const std::vector<Value>& args);
LAMINA_API Value cas_inverse(const std::vector<Value>& args);
LAMINA_API Value cas_transpose(const std::vector<Value>& args);
LAMINA_API Value cas_rref(const std::vector<Value>& args);
